...
class JanggiGameTest(unittest.TestCase):
    ...
    def test_check_mate(self):
        ...
        self.assertEqual(move_complete, True)
        move_complete = self.my_game.make_move((2, 4), (2, 5))
        move_complete = self.my_game.make_move((2, 4), (2, 4))
        move_complete = self.my_game.make_move((2, 5), (1, 5))
        self.assertEqual(move_complete, True)
        in_check = self.my_game.is_in_check("red")
        self.assertEqual(in_check, True)
        move_complete = self.my_game.make_move((0, 5), (0, 4))
        self.assertEqual(move_complete, True)
        #move_complete = self.my_game.make_move((1, 5), (0, 5))
        #self.assertEqual(move_complete, True)
        #self.my_game.make_move((1, 5), (1, 5))
        #move_complete = self.my_game.make_move((1, 6), (1, 5))
        move_complete = self.my_game.make_move((1, 6), (2, 6))
        self.assertEqual(move_complete, True)
        self.my_game.make_move((1, 5), (1, 5))
    ...
    def test_check_2(self):
        ...
        result = self.my_game.get_game_state()
        self.assertEqual("UNFINISHED", result)
        move_complete = self.my_game.make_move((1, 5), (1, 5))
        self.assertEqual(move_complete, True)
        result = self.my_game.get_game_state()
        self.assertEqual("UNFINISHED", result)
        move_complete = self.my_game.make_move((2, 5), (2, 4))
    ...
    def test_problem_check(self):
        ...
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((0, 8), (1, 8))
        self.assertEqual(True, move_complete)
        ...
        move_complete = self.my_game.make_move((9, 0), (9, 0))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((1, 5), (9, 5))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((8, 4), (7, 4))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((9, 5), (9, 3))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((8, 4), (8, 4))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((9, 3), (9, 2))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((8, 4), (8, 4))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((9, 2), (8, 2))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((8, 4), (8, 4))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((1, 4), (2, 3))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((8, 4), (8, 4))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((2, 1), (2, 4))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((8, 4), (8, 4))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((3, 4), (3, 3))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((7, 4), (7, 5))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((8, 2), (8, 4))
        self.assertEqual(True, move_complete)
        move_complete = self.my_game.make_move((8, 0), (8, 4))
        self.assertEqual(True, move_complete)
        result = self.my_game.get_game_state()
        self.assertEqual("UNFINISHED", result)
